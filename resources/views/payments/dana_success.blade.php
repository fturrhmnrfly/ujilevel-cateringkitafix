...
<body>
  ...
  <div class="container">
    ...
    <div class="detail-section">
        ...
        <div class="item-details">
            <div>
                ...
                <div style="color: #666; font-size: 12px;">{{ $item->quantity }} x Rp {{ number_format($item->price, 0, ',', '.') }}</div>
            </div>
            <span class="price">Rp {{ number_format($item->quantity * $item->price, 0, ',', '.') }}</span>
        </div>
        @endforeach
    </div>
    ...
    @else
    <div class="payment-info">
        <h3 class="success-title">Data Pesanan Tidak Ditemukan</h3>
        <p class="success-subtitle">Silakan kembali ke halaman utama dan coba lagi.</p>
    </div>
    @endif
