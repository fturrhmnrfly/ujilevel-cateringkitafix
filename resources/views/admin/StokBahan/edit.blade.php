...
<head>
    ...
    <style>
        * {
        ...
        .form-control:focus {
            border-color: #4040ff;
            box-shadow: 0 0 0 3px rgba(64, 64, 255, 0.3);
        }
...
<body>
    <div class="sidebar">
        ...
        <div class="menu-item active">Kelola Makanan</div>
    ...
    <div class="main-content">
        ...
        <h2 class="page-title" style="text-align: center">Edit Bahan</h2>
        <div class="content">
            <div class="form-wrapper">
                <form action="{{ route('admin.stokbahan.update', $stokBahan) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" 
                               ...
                               id="tanggal_ditambahkan" 
                               class="form-control"
                               value="{{ old('tanggal_ditambahkan', $stokBahan->tanggal_ditambahkan->format('Y-m-d')) }}" 
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" 
                               ...
                               class="form-control"
                               value="{{ old('tanggal_kadaluarsa', $stokBahan->tanggal_kadaluarsa->format('Y-m-d')) }}" 
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" 
                                ...
                                class="form-control"
                                required>
                            <option value="tersedia" {{ old('status', $stokBahan->status) == 'tersedia' ? 'selected' : '' }}>Tersedia</option>
                            <option value="kosong" {{ old('status', $stokBahan->status) == 'kosong' ? 'selected' : '' }}>Kosong</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  class="form-control"
                                  rows="3"
                                  required>{{ old('deskripsi', $stokBahan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
