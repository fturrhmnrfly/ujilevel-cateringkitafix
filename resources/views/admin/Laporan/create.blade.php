...
<body>
    ...
    <div class="main-content">
        ...
        <h2 class="page-title" style="text-align: center">Buat Laporan Baru</h2>
        <div class="content">
            <div class="form-wrapper">
                <form action="{{ route('admin.laporan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="laporan" id="laporan" class="form-control" placeholder="Masukkan nama laporan" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="admin" id="admin" class="form-control" placeholder="Masukkan nama admin" required>
                    </div>

                    <div class="form-group">
                        <label for="deskripsi">Deskripsi</label>
                        <textarea name="deskripsi" id="deskripsi" class="form-control" placeholder="Masukkan deskripsi laporan"></textarea>
                    </div>
                    ...
                    <button type="submit" class="btn-tambahkan">Buat</button>
                </form>
            </div>
        </div>
    </div>
