...
<body>
    ...
    <div class="main-content">
        <x-admin-header title="Edit Laporan Keuangan" />
            ...
            <form action="{{ route('admin.laporan.update', $laporan->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="laporan" name="laporan" class="form-control" 
                           ...
                           value="{{ old('laporan', $laporan->laporan) }}" required>
                    @error('laporan')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="jenis_laporan" name="jenis_laporan" class="form-control" required>
                            ...
                            <option value="pemasukan" {{ old('jenis_laporan', $laporan->jenis_laporan) == 'pemasukan' ? 'selected' : '' }}>Pemasukan</option>
                            <option value="pengeluaran" {{ old('jenis_laporan', $laporan->jenis_laporan) == 'pengeluaran' ? 'selected' : '' }}>Pengeluaran</option>
                        </select>
                        @error('jenis_laporan')
                            <small style="color: #dc3545;">{{ $message }}</small>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="total" name="total" class="form-control" 
                           ...
                           value="{{ old('total', $laporan->total) }}" min="0" step="1000" required>
                    @error('total')
                        <small style="color: #dc3545;">{{ $message }}</small>
                    @enderror
                </div>
